...
function AboutSection() {
    return (
        <section className="flex h-auto w-full flex-col items-center gap-6 px-8 pt-7 pb-12 md:p-16 md:pt-12">
            ...
            <div className="flex flex-col gap-6">
                <img
                    src={aboutImg}
                    alt="About Me"
                    className="hidden max-w-1/2 md:block"
                />
                <div className="flex flex-col gap-6 md:max-w-4/5 md:gap-2">
